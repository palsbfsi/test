...
package com.ajeetkumar.textdetectionusingmlkit.camera;
...
public class CameraSource {
  ...
  private FaceRecognitionProcessor frameProcessor;
  ...
  public void setMachineLearningFrameProcessor(FaceRecognitionProcessor processor) {
    synchronized (processorLock) {
      cleanScreen();
      if (frameProcessor != null) {
        frameProcessor.stop();
